...
class NeuralNetwork:
    """
    神经网络
    支持深度网络 设计一个5层网络，则layers_strcuture=[2,10,7,5,2]
    """
    ...
    def init_w_and_b(self):
        ...
        #    w1 = array([[0.7580629  0.27585345]
        #               [0.30997013 0.96847458]
        #               [0.48596715 0.52874384]
        #               [0.98308907 0.65337816]]
...
def plot_decision_boundary(xy, colors, pred_func):
    # xy是坐标点的集合，把集合的范围算出来
    # 加减0.5相当于扩大画布的范围，不然画出来的图坐标点会落在图的边缘
